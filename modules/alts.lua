...
local function character_line(name, money, played, level, realm, faction, race, class)
	...
	line.realm:SetFont(recUI.media.font, 9, nil)
	...
	line.faction:SetFont(recUI.media.font, 9, nil)
	...
	line.class:SetFont(recUI.media.font, 9, nil)
	...
	line.race:SetFont(recUI.media.font, 9, nil)
	...
	line.money:SetFont(recUI.media.font, 9, nil)
	...
	line.played:SetFont(recUI.media.font, 9, nil)
