...
output_frame.bg:SetBackdrop(recMedia.backdrop_table)
...
local function character_line(name, money, played, level, realm, faction, race, class)
	...
	line.realm:SetFont(recMedia.fontFace.NORMAL, 9, nil)
	...
	line.faction:SetFont(recMedia.fontFace.NORMAL, 9, nil)
	...
	line.class:SetFont(recMedia.fontFace.NORMAL, 9, nil)
	...
	line.race:SetFont(recMedia.fontFace.NORMAL, 9, nil)
	...
	line.money:SetFont(recMedia.fontFace.NORMAL, 9, nil)
	...
	line.played:SetFont(recMedia.fontFace.NORMAL, 9, nil)
