...
--opt.mode_font_face = recUI.media.font
...
opt.bar_texture = recUI.media.statusBar
opt.bar_font_face = recUI.media.font
opt.bar_font_size = 9
opt.bar_font_flags = ""
...
opt.button_width = 10
opt.button_font_face = recUI.media.font
...
buttonFont:SetFont(recUI.media.font, 8, "THINOUTLINE")
...
local function MakeDisplay()
	...
	local function MakeText(index, direction)
		...
		t:SetFont(recUI.media.font, 8, "THINOUTLINE")
