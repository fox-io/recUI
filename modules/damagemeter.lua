...
opt.bar_texture = [[Interface\AddOns\recDamageMeter\media\minimalist.tga]]	-- Texture of the bars:
opt.bar_font_face = [[Interface\AddOns\recMedia\fonts\Oceania-Medium.ttf]]
opt.bar_font_size = 9
opt.bar_font_flags = ""
...
opt.button_width = 10
opt.button_font_face = [[Interface\AddOns\recMedia\fonts\Oceania-Medium.ttf]]
...
local function MakeDisplay()
	...
	local function MakeButton(caption, from_point, to_point, x_offset, y_offset)
		...
		b:SetNormalFontObject(recMedia.fontObject("SMALL", 8, "THINOUTLINE"))
	...
	local function MakeText(index, direction)
		...
		t:SetFont(recMedia.fontFace.SMALL, 8, "THINOUTLINE")
	...
	f.modetext:SetNormalFontObject(recMedia.fontObject("SMALL", 8, "THINOUTLINE"))
