...
cfg.slot_bg_file		= recUI.media.buttonBackdrop
cfg.slot_edge_file		= ""
cfg.slot_edge_size		= 0
cfg.slot_inset			= 0
cfg.normal_texture		= recUI.media.buttonNormal
cfg.pushed_texture		= recUI.media.buttonPushed
cfg.highlight_texture	= recUI.media.buttonHighlight
...
cfg.bag_bg_file			= recUI.media.bgFile
cfg.bag_edge_file		= recUI.media.edgeFile
...
cfg.button_normal_texture	= recUI.media.buttonNormal
cfg.button_pushed_texture	= recUI.media.buttonPushed
cfg.button_highlight_texture	= recUI.media.buttonHighlight
...
cfg.rarity_overlay_texture	= recUI.media.buttonGloss
...
cfg.rarity_border_texture = recUI.media.buttonEquipped
